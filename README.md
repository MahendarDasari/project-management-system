...
Develop/Code the above scenario using below technologies:
1.	.Net Core Web API
2.	Any ORM (EF Core, Dapper and NHibernate)
3.	Any Database (SQL Server, Oracle etc.)
4.	Client-side tech (React (Preferred), Angular and Vue)
